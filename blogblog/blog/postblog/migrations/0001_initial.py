# Generated by Django 2.2.3 on 2022-09-22 10:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concent', models.TextField(verbose_name='内容')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('motified', models.DateTimeField(auto_now=True)),
                ('isdelete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='postblog.Category', verbose_name='所属类别')),
                ('tag', models.ManyToManyField(to='postblog.Tag', verbose_name='所属标签')),
            ],
            options={
